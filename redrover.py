...
# Given a string containing [N, E, S, W] with a max length of 100 and the
# ability to substitute 'M' for all occurrences of a particular substring,
# figure out the minimum number of characters required to produce the two
# required strings (1. message with 'M's; 2. substitution value).
#
# The solution involves identifying all distinct subsequences in the
# original string then trying each one out to determine which produces the
# optimal result.
